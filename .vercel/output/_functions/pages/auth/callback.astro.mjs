...
const $$Callback = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "Signing In - QuickQR" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="auth-container"> <div class="auth-card"> ${authError ? renderTemplate`<div class="auth-header"> <h1>Sign In Error</h1> <p style="color: #ef4444;">${authError}</p> <a href="/auth/signin" style="color: #14b8a6; marginTop: " 1rem", display: "inline-block"}>Try again</a> </div>` : renderTemplate`<div class="auth-loading"> <div class="spinner"></div> <p>Signing you in...</p> </div>`} </div> </div> ` })}`;
